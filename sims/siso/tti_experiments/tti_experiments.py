...
def autoUE():
    global flag
    flag=1
    os.system("docker compose -f ../../oai-cn/docker-compose.yaml up mysql -d")
    time.sleep(60) 
    os.system("docker compose -f ../../oai-cn/docker-compose.yaml up oai-upf oai-ims oai-ext-dn oai-smf oai-amf oai-ausf oai-udm oai-udr oai-nrf -d")
